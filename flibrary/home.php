...
<!-- end of displaying the available books -->		
       ...
       <br><h5 style="display:inline;">Click here to </h5><button class="btn btn-primary btn-sm"><a href="logout.php" title="logout"><span style="color:black;">Logout</span></a></button></br>		
        </form>
        </form>
