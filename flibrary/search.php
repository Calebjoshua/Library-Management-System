...
<head>
  ...
  <script type="text/javascript" src="reservecheck.php"></script>
  <style>
       .H2{
    text-align:right;
    display:block;
      ...
      <?php  
        ...
        <div class="navbar navbar-inverse" style="height:5px">
		   <form role="form" id="templatemo-preferences-form" name="reservation" action="reserve.php" method="post">
            ...
            <br/>
            <button class="btn btn-success btn-sm" type="submit"  name="Reserve"  value="Reserve" ><a href="reserve.php">Reserve</a></button>
             </div>
             </div>
        </form> 
                            </div>
...
<form>
       ...
       <br><p style="display:inline;">Click here to </h5><button class="btn btn-primary btn-sm"> <a href="home.php" title="search"><span style="color:white">Search</span></a></button></br>  
       <br><h5 style="display:inline;">Click here to </h5><button class="btn btn-primary btn-sm"> <a href="logout.php" title="logout"><span style="color:white">Logout</span></a></button></br>		
        </form>
